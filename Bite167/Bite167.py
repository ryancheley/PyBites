class User:
    ...
    def username(self):
        ...
        """
        # TODO 2: you code
        return self.first_name.lower()[0]+self.last_name.lower()[0:6]
    ...
    def __repr__(self):
        ...
        """
        return f'{self.__class__.__name__}('+f'"{self.first_name}", '+ f'"{self.last_name}")'

c = User(first_name='ryan', last_name='zimmerman')
