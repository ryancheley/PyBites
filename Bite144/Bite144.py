...
def calc_months_passed(year, month, day):
    ...
    try:
        ...
        rd = relativedelta(input_date, START_DATE)
        month_to_add = 0
        if rd.days >= MIN_DAYS_TO_COUNT_AS_MONTH:
            month_to_add = 1

        result = month_to_add + rd.years * MONTHS_PER_YEAR + rd.months
...
c = calc_months_passed(2018, 11, 10)
print(c)