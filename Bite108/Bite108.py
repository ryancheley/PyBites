...
def get_total_points(belts=ninja_belts):
    ...
    belt_colors = belts.keys()
    score = 0
    for b in belt_colors:
        score = score + belts.get(b).score * belts.get(b).ninjas
    return score


t, u = get_total_points(ninja_belts), get_total_points(ninja_belts_updated)
